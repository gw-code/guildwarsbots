...
Global Const $ITEM_ID_Chittin_Fragment = 954
...
#Region Sales
Global $wontSell[10] = [$ITEM_ID_Glacial_Stone, $ITEM_ID_Feathered_Crest, $ITEM_ID_feather, $ITEM_ID_bone, $ITEM_ID_Pile_of_Elemental_Dust, $ITEM_ID_Lockpick, $ITEM_ID_EXP_Salvage_Kit, $ITEM_ID_Salvage_Kit, $ITEM_ID_ID_Kit, $ITEM_ID_SUP_ID_Kit]
_ArrayConcatenate($wontSell, $Alcohol_Array)
_ArrayConcatenate($wontSell, $DPRemoval_Sweets)
_ArrayConcatenate($wontSell, $Sweet_Pcon_Array)
_ArrayConcatenate($wontSell, $Sweet_Town_Array)
